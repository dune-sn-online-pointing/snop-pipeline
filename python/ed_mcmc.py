...
This script expects an input .npz produced by `ed_inference_from_mt.py` which must contain:
...
def main():
    ...
    p.add_argument('ed_inference_npz', help='.npz created by ed_inference_from_mt.py')
