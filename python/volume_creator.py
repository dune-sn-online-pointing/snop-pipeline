...
Creates 3D volumes around main track clusters using the online-pointing-utils
submodule scripts.
"""
...
def create_volumes(images, metadata, pointing_utils_dir, output_dir,
    ...
    """
    Create 3D volumes for main track clusters.
    
    This function interfaces with the online-pointing-utils submodule to create
    volumes around the selected main track clusters. It:
    ...
    Args:
        images: Main track cluster images (N, H, W, C)
