...
INPUT_JSON=/afs/cern.ch/work/d/dapullia/public/dune/data-selection-pipeline/json/3_test.json
OUTPUT_FOLDER=/afs/cern.ch/work/d/dapullia/public/dune/data-selection-pipeline/output/3_test/
