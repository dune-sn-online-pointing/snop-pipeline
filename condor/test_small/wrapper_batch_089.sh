#!/bin/bash
# Wrapper for SN analysis batch 89

set -e

echo "=========================================="
echo "SN Analysis Batch 89"
echo "Categories: cat000467,cat000468,cat000469,cat000470,cat000471"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000467,cat000468,cat000469,cat000470,cat000471"

echo "Batch 89 completed: $(date)"
