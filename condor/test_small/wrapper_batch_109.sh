#!/bin/bash
# Wrapper for SN analysis batch 109

set -e

echo "=========================================="
echo "SN Analysis Batch 109"
echo "Categories: cat000568,cat000569,cat000570,cat000571,cat000572"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000568,cat000569,cat000570,cat000571,cat000572"

echo "Batch 109 completed: $(date)"
