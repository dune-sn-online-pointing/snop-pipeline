#!/bin/bash
# Wrapper for SN analysis batch 50

set -e

echo "=========================================="
echo "SN Analysis Batch 50"
echo "Categories: cat000257,cat000258,cat000259,cat000260,cat000261"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000257,cat000258,cat000259,cat000260,cat000261"

echo "Batch 50 completed: $(date)"
