#!/bin/bash
# Wrapper for SN analysis batch 80

set -e

echo "=========================================="
echo "SN Analysis Batch 80"
echo "Categories: cat000422,cat000423,cat000424,cat000425,cat000426"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000422,cat000423,cat000424,cat000425,cat000426"

echo "Batch 80 completed: $(date)"
