#!/bin/bash
# Wrapper for SN analysis batch 74

set -e

echo "=========================================="
echo "SN Analysis Batch 74"
echo "Categories: cat000377,cat000378,cat000379,cat000380,cat000381"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000377,cat000378,cat000379,cat000380,cat000381"

echo "Batch 74 completed: $(date)"
