#!/bin/bash
# Wrapper for SN analysis batch 4

set -e

echo "=========================================="
echo "SN Analysis Batch 4"
echo "Categories: cat000021,cat000022,cat000023,cat000024,cat000025"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000021,cat000022,cat000023,cat000024,cat000025"
