#!/bin/bash
# Wrapper for SN analysis batch 71

set -e

echo "=========================================="
echo "SN Analysis Batch 71"
echo "Categories: cat000362,cat000363,cat000364,cat000365,cat000366"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000362,cat000363,cat000364,cat000365,cat000366"

echo "Batch 71 completed: $(date)"
