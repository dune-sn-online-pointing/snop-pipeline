#!/bin/bash
# Wrapper for SN analysis batch 42

set -e

echo "=========================================="
echo "SN Analysis Batch 42"
echo "Categories: cat000217,cat000218,cat000219,cat000220,cat000221"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000217,cat000218,cat000219,cat000220,cat000221"
