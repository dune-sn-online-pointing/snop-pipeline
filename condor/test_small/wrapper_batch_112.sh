#!/bin/bash
# Wrapper for SN analysis batch 112

set -e

echo "=========================================="
echo "SN Analysis Batch 112"
echo "Categories: cat000583,cat000584,cat000585,cat000586,cat000587"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000583,cat000584,cat000585,cat000586,cat000587"

echo "Batch 112 completed: $(date)"
