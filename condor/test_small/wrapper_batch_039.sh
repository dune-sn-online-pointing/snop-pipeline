#!/bin/bash
# Wrapper for SN analysis batch 39

set -e

echo "=========================================="
echo "SN Analysis Batch 39"
echo "Categories: cat000202,cat000203,cat000204,cat000205,cat000206"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000202,cat000203,cat000204,cat000205,cat000206"
