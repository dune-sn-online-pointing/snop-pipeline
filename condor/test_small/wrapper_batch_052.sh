#!/bin/bash
# Wrapper for SN analysis batch 52

set -e

echo "=========================================="
echo "SN Analysis Batch 52"
echo "Categories: cat000267,cat000268,cat000269,cat000270,cat000271"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000267,cat000268,cat000269,cat000270,cat000271"

echo "Batch 52 completed: $(date)"
