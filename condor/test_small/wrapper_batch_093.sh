#!/bin/bash
# Wrapper for SN analysis batch 93

set -e

echo "=========================================="
echo "SN Analysis Batch 93"
echo "Categories: cat000487,cat000488,cat000489,cat000490,cat000491"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000487,cat000488,cat000489,cat000490,cat000491"

echo "Batch 93 completed: $(date)"
