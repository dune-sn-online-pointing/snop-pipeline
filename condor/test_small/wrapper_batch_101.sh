#!/bin/bash
# Wrapper for SN analysis batch 101

set -e

echo "=========================================="
echo "SN Analysis Batch 101"
echo "Categories: cat000527,cat000528,cat000529,cat000530,cat000531"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000527,cat000528,cat000529,cat000530,cat000531"

echo "Batch 101 completed: $(date)"
