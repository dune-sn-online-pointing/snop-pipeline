#!/bin/bash
# Wrapper for SN analysis batch 34

set -e

echo "=========================================="
echo "SN Analysis Batch 34"
echo "Categories: cat000176,cat000177,cat000179,cat000180,cat000181"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000176,cat000177,cat000179,cat000180,cat000181"
