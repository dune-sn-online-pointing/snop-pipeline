#!/bin/bash
# Wrapper for SN analysis batch 30

set -e

echo "=========================================="
echo "SN Analysis Batch 30"
echo "Categories: cat000156,cat000157,cat000158,cat000159,cat000160"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000156,cat000157,cat000158,cat000159,cat000160"

echo "Batch 30 completed: $(date)"
