#!/bin/bash
# Wrapper for SN analysis batch 13

set -e

echo "=========================================="
echo "SN Analysis Batch 13"
echo "Categories: cat000071,cat000072,cat000073,cat000074,cat000075"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000071,cat000072,cat000073,cat000074,cat000075"

echo "Batch 13 completed: $(date)"
