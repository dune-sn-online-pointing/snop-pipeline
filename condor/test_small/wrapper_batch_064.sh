#!/bin/bash
# Wrapper for SN analysis batch 64

set -e

echo "=========================================="
echo "SN Analysis Batch 64"
echo "Categories: cat000327,cat000328,cat000329,cat000330,cat000331"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000327,cat000328,cat000329,cat000330,cat000331"

echo "Batch 64 completed: $(date)"
