#!/bin/bash
# Wrapper for SN analysis batch 111

set -e

echo "=========================================="
echo "SN Analysis Batch 111"
echo "Categories: cat000578,cat000579,cat000580,cat000581,cat000582"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000578,cat000579,cat000580,cat000581,cat000582"

echo "Batch 111 completed: $(date)"
