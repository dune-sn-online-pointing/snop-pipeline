#!/bin/bash
# Wrapper for SN analysis batch 33

set -e

echo "=========================================="
echo "SN Analysis Batch 33"
echo "Categories: cat000171,cat000172,cat000173,cat000174,cat000175"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000171,cat000172,cat000173,cat000174,cat000175"
