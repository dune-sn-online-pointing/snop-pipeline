#!/bin/bash
# Wrapper for SN analysis batch 106

set -e

echo "=========================================="
echo "SN Analysis Batch 106"
echo "Categories: cat000552,cat000553,cat000554,cat000555,cat000556"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000552,cat000553,cat000554,cat000555,cat000556"

echo "Batch 106 completed: $(date)"
