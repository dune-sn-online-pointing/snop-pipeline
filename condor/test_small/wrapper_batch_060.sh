#!/bin/bash
# Wrapper for SN analysis batch 60

set -e

echo "=========================================="
echo "SN Analysis Batch 60"
echo "Categories: cat000307,cat000308,cat000309,cat000310,cat000311"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000307,cat000308,cat000309,cat000310,cat000311"

echo "Batch 60 completed: $(date)"
