#!/bin/bash
# Wrapper for SN analysis batch 14

set -e

echo "=========================================="
echo "SN Analysis Batch 14"
echo "Categories: cat000076,cat000077,cat000078,cat000079,cat000080"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000076,cat000077,cat000078,cat000079,cat000080"

echo "Batch 14 completed: $(date)"
