#!/bin/bash
# Wrapper for SN analysis batch 79

set -e

echo "=========================================="
echo "SN Analysis Batch 79"
echo "Categories: cat000409,cat000410,cat000419,cat000420,cat000421"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000409,cat000410,cat000419,cat000420,cat000421"

echo "Batch 79 completed: $(date)"
