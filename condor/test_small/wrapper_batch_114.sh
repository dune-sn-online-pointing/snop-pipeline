#!/bin/bash
# Wrapper for SN analysis batch 114

set -e

echo "=========================================="
echo "SN Analysis Batch 114"
echo "Categories: cat000593,cat000594,cat000595,cat000596,cat000598"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000593,cat000594,cat000595,cat000596,cat000598"

echo "Batch 114 completed: $(date)"
