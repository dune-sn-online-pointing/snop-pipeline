#!/bin/bash
# Wrapper for SN analysis batch 17

set -e

echo "=========================================="
echo "SN Analysis Batch 17"
echo "Categories: cat000091,cat000092,cat000093,cat000094,cat000095"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000091,cat000092,cat000093,cat000094,cat000095"
