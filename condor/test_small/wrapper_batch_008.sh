#!/bin/bash
# Wrapper for SN analysis batch 8

set -e

echo "=========================================="
echo "SN Analysis Batch 8"
echo "Categories: cat000041,cat000042,cat000043,cat000044,cat000045"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000041,cat000042,cat000043,cat000044,cat000045"
