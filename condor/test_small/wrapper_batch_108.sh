#!/bin/bash
# Wrapper for SN analysis batch 108

set -e

echo "=========================================="
echo "SN Analysis Batch 108"
echo "Categories: cat000562,cat000563,cat000564,cat000565,cat000566"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000562,cat000563,cat000564,cat000565,cat000566"

echo "Batch 108 completed: $(date)"
