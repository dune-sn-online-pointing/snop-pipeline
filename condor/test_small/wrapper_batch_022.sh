#!/bin/bash
# Wrapper for SN analysis batch 22

set -e

echo "=========================================="
echo "SN Analysis Batch 22"
echo "Categories: cat000116,cat000117,cat000118,cat000119,cat000120"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000116,cat000117,cat000118,cat000119,cat000120"
