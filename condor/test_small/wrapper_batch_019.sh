#!/bin/bash
# Wrapper for SN analysis batch 19

set -e

echo "=========================================="
echo "SN Analysis Batch 19"
echo "Categories: cat000101,cat000102,cat000103,cat000104,cat000105"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000101,cat000102,cat000103,cat000104,cat000105"

echo "Batch 19 completed: $(date)"
