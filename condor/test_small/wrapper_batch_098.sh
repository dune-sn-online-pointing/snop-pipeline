#!/bin/bash
# Wrapper for SN analysis batch 98

set -e

echo "=========================================="
echo "SN Analysis Batch 98"
echo "Categories: cat000512,cat000513,cat000514,cat000515,cat000516"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000512,cat000513,cat000514,cat000515,cat000516"

echo "Batch 98 completed: $(date)"
