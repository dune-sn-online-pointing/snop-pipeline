#!/bin/bash
# Wrapper for SN analysis batch 62

set -e

echo "=========================================="
echo "SN Analysis Batch 62"
echo "Categories: cat000317,cat000318,cat000319,cat000320,cat000321"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000317,cat000318,cat000319,cat000320,cat000321"

echo "Batch 62 completed: $(date)"
