#!/bin/bash
# Wrapper for SN analysis batch 69

set -e

echo "=========================================="
echo "SN Analysis Batch 69"
echo "Categories: cat000352,cat000353,cat000354,cat000355,cat000356"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000352,cat000353,cat000354,cat000355,cat000356"

echo "Batch 69 completed: $(date)"
