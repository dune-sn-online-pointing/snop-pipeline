#!/bin/bash
# Wrapper for SN analysis batch 32

set -e

echo "=========================================="
echo "SN Analysis Batch 32"
echo "Categories: cat000166,cat000167,cat000168,cat000169,cat000170"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000166,cat000167,cat000168,cat000169,cat000170"
