#!/bin/bash
# Wrapper for SN analysis batch 43

set -e

echo "=========================================="
echo "SN Analysis Batch 43"
echo "Categories: cat000222,cat000223,cat000224,cat000225,cat000226"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000222,cat000223,cat000224,cat000225,cat000226"

echo "Batch 43 completed: $(date)"
