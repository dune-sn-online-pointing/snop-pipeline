#!/bin/bash
# Wrapper for SN analysis batch 104

set -e

echo "=========================================="
echo "SN Analysis Batch 104"
echo "Categories: cat000542,cat000543,cat000544,cat000545,cat000546"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000542,cat000543,cat000544,cat000545,cat000546"

echo "Batch 104 completed: $(date)"
