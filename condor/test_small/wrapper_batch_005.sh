#!/bin/bash
# Wrapper for SN analysis batch 5

set -e

echo "=========================================="
echo "SN Analysis Batch 5"
echo "Categories: cat000026,cat000027,cat000028,cat000029,cat000030"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000026,cat000027,cat000028,cat000029,cat000030"
