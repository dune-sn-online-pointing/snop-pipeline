#!/bin/bash
# Wrapper for SN analysis batch 2

set -e

echo "=========================================="
echo "SN Analysis Batch 2"
echo "Categories: cat000011,cat000012,cat000013,cat000014,cat000015"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000011,cat000012,cat000013,cat000014,cat000015"
