#!/bin/bash
# Wrapper for SN analysis batch 56

set -e

echo "=========================================="
echo "SN Analysis Batch 56"
echo "Categories: cat000287,cat000288,cat000289,cat000290,cat000291"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000287,cat000288,cat000289,cat000290,cat000291"

echo "Batch 56 completed: $(date)"
