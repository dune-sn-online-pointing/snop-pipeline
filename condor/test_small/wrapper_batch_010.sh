#!/bin/bash
# Wrapper for SN analysis batch 10

set -e

echo "=========================================="
echo "SN Analysis Batch 10"
echo "Categories: cat000056,cat000057,cat000058,cat000059,cat000060"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000056,cat000057,cat000058,cat000059,cat000060"
