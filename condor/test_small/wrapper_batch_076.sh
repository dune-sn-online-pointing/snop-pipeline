#!/bin/bash
# Wrapper for SN analysis batch 76

set -e

echo "=========================================="
echo "SN Analysis Batch 76"
echo "Categories: cat000394,cat000395,cat000396,cat000397,cat000398"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000394,cat000395,cat000396,cat000397,cat000398"

echo "Batch 76 completed: $(date)"
