#!/bin/bash
# Wrapper for SN analysis batch 68

set -e

echo "=========================================="
echo "SN Analysis Batch 68"
echo "Categories: cat000347,cat000348,cat000349,cat000350,cat000351"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000347,cat000348,cat000349,cat000350,cat000351"

echo "Batch 68 completed: $(date)"
