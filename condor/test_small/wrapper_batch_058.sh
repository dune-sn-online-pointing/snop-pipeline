#!/bin/bash
# Wrapper for SN analysis batch 58

set -e

echo "=========================================="
echo "SN Analysis Batch 58"
echo "Categories: cat000297,cat000298,cat000299,cat000300,cat000301"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000297,cat000298,cat000299,cat000300,cat000301"

echo "Batch 58 completed: $(date)"
