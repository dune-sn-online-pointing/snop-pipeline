#!/bin/bash
# Wrapper for SN analysis batch 92

set -e

echo "=========================================="
echo "SN Analysis Batch 92"
echo "Categories: cat000482,cat000483,cat000484,cat000485,cat000486"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000482,cat000483,cat000484,cat000485,cat000486"

echo "Batch 92 completed: $(date)"
