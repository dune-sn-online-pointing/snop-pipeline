#!/bin/bash
# Wrapper for SN analysis batch 18

set -e

echo "=========================================="
echo "SN Analysis Batch 18"
echo "Categories: cat000096,cat000097,cat000098,cat000099,cat000100"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000096,cat000097,cat000098,cat000099,cat000100"
