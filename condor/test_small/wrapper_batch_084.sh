#!/bin/bash
# Wrapper for SN analysis batch 84

set -e

echo "=========================================="
echo "SN Analysis Batch 84"
echo "Categories: cat000442,cat000443,cat000444,cat000445,cat000446"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000442,cat000443,cat000444,cat000445,cat000446"

echo "Batch 84 completed: $(date)"
