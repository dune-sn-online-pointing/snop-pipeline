#!/bin/bash
# Wrapper for SN analysis batch 105

set -e

echo "=========================================="
echo "SN Analysis Batch 105"
echo "Categories: cat000547,cat000548,cat000549,cat000550,cat000551"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000547,cat000548,cat000549,cat000550,cat000551"

echo "Batch 105 completed: $(date)"
