#!/bin/bash
# Wrapper for SN analysis batch 0

set -e

echo "=========================================="
echo "SN Analysis Batch 0"
echo "Categories: cat000001,cat000002,cat000003,cat000004,cat000005"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000001,cat000002,cat000003,cat000004,cat000005"

echo "Batch 0 completed: $(date)"
