#!/bin/bash
# Wrapper for SN analysis batch 94

set -e

echo "=========================================="
echo "SN Analysis Batch 94"
echo "Categories: cat000492,cat000493,cat000494,cat000495,cat000496"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000492,cat000493,cat000494,cat000495,cat000496"

echo "Batch 94 completed: $(date)"
