#!/bin/bash
# Wrapper for SN analysis batch 73

set -e

echo "=========================================="
echo "SN Analysis Batch 73"
echo "Categories: cat000372,cat000373,cat000374,cat000375,cat000376"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000372,cat000373,cat000374,cat000375,cat000376"

echo "Batch 73 completed: $(date)"
