#!/bin/bash
# Wrapper for SN analysis batch 9

set -e

echo "=========================================="
echo "SN Analysis Batch 9"
echo "Categories: cat000046,cat000050,cat000051,cat000054,cat000055"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000046,cat000050,cat000051,cat000054,cat000055"
