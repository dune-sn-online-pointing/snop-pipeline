#!/bin/bash
# Wrapper for SN analysis batch 12

set -e

echo "=========================================="
echo "SN Analysis Batch 12"
echo "Categories: cat000066,cat000067,cat000068,cat000069,cat000070"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000066,cat000067,cat000068,cat000069,cat000070"
