#!/bin/bash
# Wrapper for SN analysis batch 23

set -e

echo "=========================================="
echo "SN Analysis Batch 23"
echo "Categories: cat000121,cat000122,cat000123,cat000124,cat000125"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000121,cat000122,cat000123,cat000124,cat000125"
