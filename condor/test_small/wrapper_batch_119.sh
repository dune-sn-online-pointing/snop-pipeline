#!/bin/bash
# Wrapper for SN analysis batch 119

set -e

echo "=========================================="
echo "SN Analysis Batch 119"
echo "Categories: cat000620,cat000621,cat000622"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000620,cat000621,cat000622"

echo "Batch 119 completed: $(date)"
