#!/bin/bash
# Wrapper for SN analysis batch 72

set -e

echo "=========================================="
echo "SN Analysis Batch 72"
echo "Categories: cat000367,cat000368,cat000369,cat000370,cat000371"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000367,cat000368,cat000369,cat000370,cat000371"

echo "Batch 72 completed: $(date)"
