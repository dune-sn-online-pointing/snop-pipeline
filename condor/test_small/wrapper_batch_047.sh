#!/bin/bash
# Wrapper for SN analysis batch 47

set -e

echo "=========================================="
echo "SN Analysis Batch 47"
echo "Categories: cat000242,cat000243,cat000244,cat000245,cat000246"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000242,cat000243,cat000244,cat000245,cat000246"

echo "Batch 47 completed: $(date)"
