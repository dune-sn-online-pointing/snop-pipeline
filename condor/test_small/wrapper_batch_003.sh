#!/bin/bash
# Wrapper for SN analysis batch 3

set -e

echo "=========================================="
echo "SN Analysis Batch 3"
echo "Categories: cat000016,cat000017,cat000018,cat000019,cat000020"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000016,cat000017,cat000018,cat000019,cat000020"
