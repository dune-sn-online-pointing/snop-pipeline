#!/bin/bash
# Wrapper for SN analysis batch 82

set -e

echo "=========================================="
echo "SN Analysis Batch 82"
echo "Categories: cat000432,cat000433,cat000434,cat000435,cat000436"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000432,cat000433,cat000434,cat000435,cat000436"

echo "Batch 82 completed: $(date)"
