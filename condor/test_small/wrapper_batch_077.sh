#!/bin/bash
# Wrapper for SN analysis batch 77

set -e

echo "=========================================="
echo "SN Analysis Batch 77"
echo "Categories: cat000399,cat000400,cat000401,cat000402,cat000403"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000399,cat000400,cat000401,cat000402,cat000403"

echo "Batch 77 completed: $(date)"
