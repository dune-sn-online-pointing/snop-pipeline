#!/bin/bash
# Wrapper for SN analysis batch 70

set -e

echo "=========================================="
echo "SN Analysis Batch 70"
echo "Categories: cat000357,cat000358,cat000359,cat000360,cat000361"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000357,cat000358,cat000359,cat000360,cat000361"

echo "Batch 70 completed: $(date)"
