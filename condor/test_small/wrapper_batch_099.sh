#!/bin/bash
# Wrapper for SN analysis batch 99

set -e

echo "=========================================="
echo "SN Analysis Batch 99"
echo "Categories: cat000517,cat000518,cat000519,cat000520,cat000521"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000517,cat000518,cat000519,cat000520,cat000521"

echo "Batch 99 completed: $(date)"
