#!/bin/bash
# Wrapper for SN analysis batch 11

set -e

echo "=========================================="
echo "SN Analysis Batch 11"
echo "Categories: cat000061,cat000062,cat000063,cat000064,cat000065"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000061,cat000062,cat000063,cat000064,cat000065"
