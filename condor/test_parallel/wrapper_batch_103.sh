#!/bin/bash
# Wrapper for SN analysis batch 103

set -e

echo "=========================================="
echo "SN Analysis Batch 103"
echo "Categories: cat000537,cat000538,cat000539,cat000540,cat000541"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000537,cat000538,cat000539,cat000540,cat000541"

echo "Batch 103 completed: $(date)"
