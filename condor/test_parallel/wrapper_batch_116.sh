#!/bin/bash
# Wrapper for SN analysis batch 116

set -e

echo "=========================================="
echo "SN Analysis Batch 116"
echo "Categories: cat000605,cat000606,cat000607,cat000608,cat000609"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000605,cat000606,cat000607,cat000608,cat000609"

echo "Batch 116 completed: $(date)"
