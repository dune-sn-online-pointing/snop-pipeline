#!/bin/bash
# Wrapper for SN analysis batch 54

set -e

echo "=========================================="
echo "SN Analysis Batch 54"
echo "Categories: cat000277,cat000278,cat000279,cat000280,cat000281"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000277,cat000278,cat000279,cat000280,cat000281"

echo "Batch 54 completed: $(date)"
