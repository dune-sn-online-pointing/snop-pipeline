#!/bin/bash
# Wrapper for SN analysis batch 27

set -e

echo "=========================================="
echo "SN Analysis Batch 27"
echo "Categories: cat000141,cat000142,cat000143,cat000144,cat000145"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000141,cat000142,cat000143,cat000144,cat000145"
