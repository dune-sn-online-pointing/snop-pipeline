#!/bin/bash
# Wrapper for SN analysis batch 49

set -e

echo "=========================================="
echo "SN Analysis Batch 49"
echo "Categories: cat000252,cat000253,cat000254,cat000255,cat000256"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000252,cat000253,cat000254,cat000255,cat000256"

echo "Batch 49 completed: $(date)"
