#!/bin/bash
# Wrapper for SN analysis batch 97

set -e

echo "=========================================="
echo "SN Analysis Batch 97"
echo "Categories: cat000507,cat000508,cat000509,cat000510,cat000511"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000507,cat000508,cat000509,cat000510,cat000511"

echo "Batch 97 completed: $(date)"
