#!/bin/bash
# Wrapper for SN analysis batch 66

set -e

echo "=========================================="
echo "SN Analysis Batch 66"
echo "Categories: cat000337,cat000338,cat000339,cat000340,cat000341"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000337,cat000338,cat000339,cat000340,cat000341"

echo "Batch 66 completed: $(date)"
