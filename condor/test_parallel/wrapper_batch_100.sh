#!/bin/bash
# Wrapper for SN analysis batch 100

set -e

echo "=========================================="
echo "SN Analysis Batch 100"
echo "Categories: cat000522,cat000523,cat000524,cat000525,cat000526"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000522,cat000523,cat000524,cat000525,cat000526"

echo "Batch 100 completed: $(date)"
