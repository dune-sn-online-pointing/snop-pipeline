#!/bin/bash
# Wrapper for SN analysis batch 90

set -e

echo "=========================================="
echo "SN Analysis Batch 90"
echo "Categories: cat000472,cat000473,cat000474,cat000475,cat000476"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000472,cat000473,cat000474,cat000475,cat000476"

echo "Batch 90 completed: $(date)"
