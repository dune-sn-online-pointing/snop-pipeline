#!/bin/bash
# Wrapper for SN analysis batch 31

set -e

echo "=========================================="
echo "SN Analysis Batch 31"
echo "Categories: cat000161,cat000162,cat000163,cat000164,cat000165"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000161,cat000162,cat000163,cat000164,cat000165"

echo "Batch 31 completed: $(date)"
