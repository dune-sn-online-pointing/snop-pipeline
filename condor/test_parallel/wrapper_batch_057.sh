#!/bin/bash
# Wrapper for SN analysis batch 57

set -e

echo "=========================================="
echo "SN Analysis Batch 57"
echo "Categories: cat000292,cat000293,cat000294,cat000295,cat000296"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000292,cat000293,cat000294,cat000295,cat000296"

echo "Batch 57 completed: $(date)"
