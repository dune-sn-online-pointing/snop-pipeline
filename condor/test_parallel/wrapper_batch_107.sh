#!/bin/bash
# Wrapper for SN analysis batch 107

set -e

echo "=========================================="
echo "SN Analysis Batch 107"
echo "Categories: cat000557,cat000558,cat000559,cat000560,cat000561"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000557,cat000558,cat000559,cat000560,cat000561"

echo "Batch 107 completed: $(date)"
