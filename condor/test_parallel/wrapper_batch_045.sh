#!/bin/bash
# Wrapper for SN analysis batch 45

set -e

echo "=========================================="
echo "SN Analysis Batch 45"
echo "Categories: cat000232,cat000233,cat000234,cat000235,cat000236"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000232,cat000233,cat000234,cat000235,cat000236"

echo "Batch 45 completed: $(date)"
