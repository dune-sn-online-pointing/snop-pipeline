#!/bin/bash
# Wrapper for SN analysis batch 96

set -e

echo "=========================================="
echo "SN Analysis Batch 96"
echo "Categories: cat000502,cat000503,cat000504,cat000505,cat000506"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000502,cat000503,cat000504,cat000505,cat000506"

echo "Batch 96 completed: $(date)"
