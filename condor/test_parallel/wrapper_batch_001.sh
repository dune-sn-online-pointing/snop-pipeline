#!/bin/bash
# Wrapper for SN analysis batch 1

set -e

echo "=========================================="
echo "SN Analysis Batch 1"
echo "Categories: cat000006,cat000007,cat000008,cat000009,cat000010"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000006,cat000007,cat000008,cat000009,cat000010"
