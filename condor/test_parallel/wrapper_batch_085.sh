#!/bin/bash
# Wrapper for SN analysis batch 85

set -e

echo "=========================================="
echo "SN Analysis Batch 85"
echo "Categories: cat000447,cat000448,cat000449,cat000450,cat000451"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000447,cat000448,cat000449,cat000450,cat000451"

echo "Batch 85 completed: $(date)"
