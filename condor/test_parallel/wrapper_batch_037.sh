#!/bin/bash
# Wrapper for SN analysis batch 37

set -e

echo "=========================================="
echo "SN Analysis Batch 37"
echo "Categories: cat000192,cat000193,cat000194,cat000195,cat000196"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000192,cat000193,cat000194,cat000195,cat000196"
