#!/bin/bash
# Wrapper for SN analysis batch 87

set -e

echo "=========================================="
echo "SN Analysis Batch 87"
echo "Categories: cat000457,cat000458,cat000459,cat000460,cat000461"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000457,cat000458,cat000459,cat000460,cat000461"

echo "Batch 87 completed: $(date)"
