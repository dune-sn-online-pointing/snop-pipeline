#!/bin/bash
# Wrapper for SN analysis batch 40

set -e

echo "=========================================="
echo "SN Analysis Batch 40"
echo "Categories: cat000207,cat000208,cat000209,cat000210,cat000211"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000207,cat000208,cat000209,cat000210,cat000211"
