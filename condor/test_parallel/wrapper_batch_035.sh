#!/bin/bash
# Wrapper for SN analysis batch 35

set -e

echo "=========================================="
echo "SN Analysis Batch 35"
echo "Categories: cat000182,cat000183,cat000184,cat000185,cat000186"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000182,cat000183,cat000184,cat000185,cat000186"

echo "Batch 35 completed: $(date)"
