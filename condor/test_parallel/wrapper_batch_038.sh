#!/bin/bash
# Wrapper for SN analysis batch 38

set -e

echo "=========================================="
echo "SN Analysis Batch 38"
echo "Categories: cat000197,cat000198,cat000199,cat000200,cat000201"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000197,cat000198,cat000199,cat000200,cat000201"

echo "Batch 38 completed: $(date)"
