#!/bin/bash
# Wrapper for SN analysis batch 24

set -e

echo "=========================================="
echo "SN Analysis Batch 24"
echo "Categories: cat000126,cat000127,cat000128,cat000129,cat000130"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000126,cat000127,cat000128,cat000129,cat000130"
