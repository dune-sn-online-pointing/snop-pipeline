#!/bin/bash
# Wrapper for SN analysis batch 51

set -e

echo "=========================================="
echo "SN Analysis Batch 51"
echo "Categories: cat000262,cat000263,cat000264,cat000265,cat000266"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000262,cat000263,cat000264,cat000265,cat000266"

echo "Batch 51 completed: $(date)"
