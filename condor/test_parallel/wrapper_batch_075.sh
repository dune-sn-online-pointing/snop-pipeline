#!/bin/bash
# Wrapper for SN analysis batch 75

set -e

echo "=========================================="
echo "SN Analysis Batch 75"
echo "Categories: cat000382,cat000383,cat000384,cat000385,cat000387"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000382,cat000383,cat000384,cat000385,cat000387"

echo "Batch 75 completed: $(date)"
