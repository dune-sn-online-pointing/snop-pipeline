#!/bin/bash
# Wrapper for SN analysis batch 113

set -e

echo "=========================================="
echo "SN Analysis Batch 113"
echo "Categories: cat000588,cat000589,cat000590,cat000591,cat000592"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000588,cat000589,cat000590,cat000591,cat000592"

echo "Batch 113 completed: $(date)"
