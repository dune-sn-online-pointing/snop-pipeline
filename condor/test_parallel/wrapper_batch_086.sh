#!/bin/bash
# Wrapper for SN analysis batch 86

set -e

echo "=========================================="
echo "SN Analysis Batch 86"
echo "Categories: cat000452,cat000453,cat000454,cat000455,cat000456"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000452,cat000453,cat000454,cat000455,cat000456"

echo "Batch 86 completed: $(date)"
