#!/bin/bash
# Wrapper for SN analysis batch 46

set -e

echo "=========================================="
echo "SN Analysis Batch 46"
echo "Categories: cat000237,cat000238,cat000239,cat000240,cat000241"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000237,cat000238,cat000239,cat000240,cat000241"

echo "Batch 46 completed: $(date)"
