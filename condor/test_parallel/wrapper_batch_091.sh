#!/bin/bash
# Wrapper for SN analysis batch 91

set -e

echo "=========================================="
echo "SN Analysis Batch 91"
echo "Categories: cat000477,cat000478,cat000479,cat000480,cat000481"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000477,cat000478,cat000479,cat000480,cat000481"

echo "Batch 91 completed: $(date)"
