#!/bin/bash
# Wrapper for SN analysis batch 20

set -e

echo "=========================================="
echo "SN Analysis Batch 20"
echo "Categories: cat000106,cat000107,cat000108,cat000109,cat000110"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000106,cat000107,cat000108,cat000109,cat000110"

echo "Batch 20 completed: $(date)"
