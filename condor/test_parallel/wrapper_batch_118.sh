#!/bin/bash
# Wrapper for SN analysis batch 118

set -e

echo "=========================================="
echo "SN Analysis Batch 118"
echo "Categories: cat000615,cat000616,cat000617,cat000618,cat000619"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000615,cat000616,cat000617,cat000618,cat000619"

echo "Batch 118 completed: $(date)"
