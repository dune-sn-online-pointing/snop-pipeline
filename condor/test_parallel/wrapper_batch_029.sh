#!/bin/bash
# Wrapper for SN analysis batch 29

set -e

echo "=========================================="
echo "SN Analysis Batch 29"
echo "Categories: cat000151,cat000152,cat000153,cat000154,cat000155"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000151,cat000152,cat000153,cat000154,cat000155"
