#!/bin/bash
# Wrapper for SN analysis batch 63

set -e

echo "=========================================="
echo "SN Analysis Batch 63"
echo "Categories: cat000322,cat000323,cat000324,cat000325,cat000326"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000322,cat000323,cat000324,cat000325,cat000326"

echo "Batch 63 completed: $(date)"
