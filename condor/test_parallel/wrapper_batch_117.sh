#!/bin/bash
# Wrapper for SN analysis batch 117

set -e

echo "=========================================="
echo "SN Analysis Batch 117"
echo "Categories: cat000610,cat000611,cat000612,cat000613,cat000614"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000610,cat000611,cat000612,cat000613,cat000614"

echo "Batch 117 completed: $(date)"
