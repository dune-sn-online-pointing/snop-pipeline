#!/bin/bash
# Wrapper for SN analysis batch 78

set -e

echo "=========================================="
echo "SN Analysis Batch 78"
echo "Categories: cat000404,cat000405,cat000406,cat000407,cat000408"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000404,cat000405,cat000406,cat000407,cat000408"

echo "Batch 78 completed: $(date)"
