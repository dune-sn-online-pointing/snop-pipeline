#!/bin/bash
# Wrapper for SN analysis batch 16

set -e

echo "=========================================="
echo "SN Analysis Batch 16"
echo "Categories: cat000086,cat000087,cat000088,cat000089,cat000090"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000086,cat000087,cat000088,cat000089,cat000090"
