#!/bin/bash
# Wrapper for SN analysis batch 110

set -e

echo "=========================================="
echo "SN Analysis Batch 110"
echo "Categories: cat000573,cat000574,cat000575,cat000576,cat000577"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000573,cat000574,cat000575,cat000576,cat000577"

echo "Batch 110 completed: $(date)"
