#!/bin/bash
# Wrapper for SN analysis batch 44

set -e

echo "=========================================="
echo "SN Analysis Batch 44"
echo "Categories: cat000227,cat000228,cat000229,cat000230,cat000231"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000227,cat000228,cat000229,cat000230,cat000231"

echo "Batch 44 completed: $(date)"
