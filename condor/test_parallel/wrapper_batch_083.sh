#!/bin/bash
# Wrapper for SN analysis batch 83

set -e

echo "=========================================="
echo "SN Analysis Batch 83"
echo "Categories: cat000437,cat000438,cat000439,cat000440,cat000441"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000437,cat000438,cat000439,cat000440,cat000441"

echo "Batch 83 completed: $(date)"
