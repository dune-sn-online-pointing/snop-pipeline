#!/bin/bash
# Wrapper for SN analysis batch 65

set -e

echo "=========================================="
echo "SN Analysis Batch 65"
echo "Categories: cat000332,cat000333,cat000334,cat000335,cat000336"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000332,cat000333,cat000334,cat000335,cat000336"

echo "Batch 65 completed: $(date)"
