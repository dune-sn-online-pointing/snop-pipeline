#!/bin/bash
# Wrapper for SN analysis batch 6

set -e

echo "=========================================="
echo "SN Analysis Batch 6"
echo "Categories: cat000031,cat000032,cat000033,cat000034,cat000035"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000031,cat000032,cat000033,cat000034,cat000035"
