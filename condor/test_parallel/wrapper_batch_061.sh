#!/bin/bash
# Wrapper for SN analysis batch 61

set -e

echo "=========================================="
echo "SN Analysis Batch 61"
echo "Categories: cat000312,cat000313,cat000314,cat000315,cat000316"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000312,cat000313,cat000314,cat000315,cat000316"

echo "Batch 61 completed: $(date)"
