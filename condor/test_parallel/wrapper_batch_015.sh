#!/bin/bash
# Wrapper for SN analysis batch 15

set -e

echo "=========================================="
echo "SN Analysis Batch 15"
echo "Categories: cat000081,cat000082,cat000083,cat000084,cat000085"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000081,cat000082,cat000083,cat000084,cat000085"
