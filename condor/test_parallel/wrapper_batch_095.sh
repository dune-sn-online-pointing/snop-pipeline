#!/bin/bash
# Wrapper for SN analysis batch 95

set -e

echo "=========================================="
echo "SN Analysis Batch 95"
echo "Categories: cat000497,cat000498,cat000499,cat000500,cat000501"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000497,cat000498,cat000499,cat000500,cat000501"

echo "Batch 95 completed: $(date)"
