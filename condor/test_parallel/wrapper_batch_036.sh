#!/bin/bash
# Wrapper for SN analysis batch 36

set -e

echo "=========================================="
echo "SN Analysis Batch 36"
echo "Categories: cat000187,cat000188,cat000189,cat000190,cat000191"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000187,cat000188,cat000189,cat000190,cat000191"
