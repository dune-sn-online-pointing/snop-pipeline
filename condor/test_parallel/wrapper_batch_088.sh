#!/bin/bash
# Wrapper for SN analysis batch 88

set -e

echo "=========================================="
echo "SN Analysis Batch 88"
echo "Categories: cat000462,cat000463,cat000464,cat000465,cat000466"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000462,cat000463,cat000464,cat000465,cat000466"

echo "Batch 88 completed: $(date)"
