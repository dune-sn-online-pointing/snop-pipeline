#!/bin/bash
# Wrapper for SN analysis batch 67

set -e

echo "=========================================="
echo "SN Analysis Batch 67"
echo "Categories: cat000342,cat000343,cat000344,cat000345,cat000346"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000342,cat000343,cat000344,cat000345,cat000346"

echo "Batch 67 completed: $(date)"
