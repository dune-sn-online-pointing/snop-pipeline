#!/bin/bash
# Wrapper for SN analysis batch 81

set -e

echo "=========================================="
echo "SN Analysis Batch 81"
echo "Categories: cat000427,cat000428,cat000429,cat000430,cat000431"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000427,cat000428,cat000429,cat000430,cat000431"

echo "Batch 81 completed: $(date)"
