#!/bin/bash
# Wrapper for SN analysis batch 21

set -e

echo "=========================================="
echo "SN Analysis Batch 21"
echo "Categories: cat000111,cat000112,cat000113,cat000114,cat000115"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000111,cat000112,cat000113,cat000114,cat000115"
