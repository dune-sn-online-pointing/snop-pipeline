#!/bin/bash
# Wrapper for SN analysis batch 28

set -e

echo "=========================================="
echo "SN Analysis Batch 28"
echo "Categories: cat000146,cat000147,cat000148,cat000149,cat000150"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000146,cat000147,cat000148,cat000149,cat000150"
