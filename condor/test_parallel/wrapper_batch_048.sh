#!/bin/bash
# Wrapper for SN analysis batch 48

set -e

echo "=========================================="
echo "SN Analysis Batch 48"
echo "Categories: cat000247,cat000248,cat000249,cat000250,cat000251"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000247,cat000248,cat000249,cat000250,cat000251"

echo "Batch 48 completed: $(date)"
