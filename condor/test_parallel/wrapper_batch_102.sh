#!/bin/bash
# Wrapper for SN analysis batch 102

set -e

echo "=========================================="
echo "SN Analysis Batch 102"
echo "Categories: cat000532,cat000533,cat000534,cat000535,cat000536"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000532,cat000533,cat000534,cat000535,cat000536"

echo "Batch 102 completed: $(date)"
