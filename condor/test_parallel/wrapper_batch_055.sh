#!/bin/bash
# Wrapper for SN analysis batch 55

set -e

echo "=========================================="
echo "SN Analysis Batch 55"
echo "Categories: cat000282,cat000283,cat000284,cat000285,cat000286"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000282,cat000283,cat000284,cat000285,cat000286"

echo "Batch 55 completed: $(date)"
