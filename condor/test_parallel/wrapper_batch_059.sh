#!/bin/bash
# Wrapper for SN analysis batch 59

set -e

echo "=========================================="
echo "SN Analysis Batch 59"
echo "Categories: cat000302,cat000303,cat000304,cat000305,cat000306"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000302,cat000303,cat000304,cat000305,cat000306"

echo "Batch 59 completed: $(date)"
