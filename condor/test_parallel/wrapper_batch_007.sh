#!/bin/bash
# Wrapper for SN analysis batch 7

set -e

echo "=========================================="
echo "SN Analysis Batch 7"
echo "Categories: cat000036,cat000037,cat000038,cat000039,cat000040"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000036,cat000037,cat000038,cat000039,cat000040"
