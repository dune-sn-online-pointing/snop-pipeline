#!/bin/bash
# Wrapper for SN analysis batch 26

set -e

echo "=========================================="
echo "SN Analysis Batch 26"
echo "Categories: cat000136,cat000137,cat000138,cat000139,cat000140"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000136,cat000137,cat000138,cat000139,cat000140"
