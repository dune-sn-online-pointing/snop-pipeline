#!/bin/bash
# Wrapper for SN analysis batch 25

set -e

echo "=========================================="
echo "SN Analysis Batch 25"
echo "Categories: cat000131,cat000132,cat000133,cat000134,cat000135"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000131,cat000132,cat000133,cat000134,cat000135"
