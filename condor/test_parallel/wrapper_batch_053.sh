#!/bin/bash
# Wrapper for SN analysis batch 53

set -e

echo "=========================================="
echo "SN Analysis Batch 53"
echo "Categories: cat000272,cat000273,cat000274,cat000275,cat000276"
echo "=========================================="
echo "Job start: $(date)"
...
python3 scripts/run_systematic_sn_analysis.py \
  ...
  --cat-range "cat000272,cat000273,cat000274,cat000275,cat000276"

echo "Batch 53 completed: $(date)"
