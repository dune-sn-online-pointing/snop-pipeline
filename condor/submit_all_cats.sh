...
environment           = "TEST_N_CC=\$(TEST_N_CC) TEST_N_ES=\$(TEST_N_ES) OUTPUT_BASE=\$(OUTPUT_BASE) BASE_CONFIG=\$(BASE_CONFIG) CT_MODEL=\$(CT_MODEL) SCENARIO_NAMES=\$(SCENARIO_NAMES) SCENARIO_CATALOG=\$(SCENARIO_CATALOG)"
